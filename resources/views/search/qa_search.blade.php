...
@section('tab_content')
    ...
    <div class="tab-content">
        <div class="tab-pane active" id="qa_search">
                ...
                <div class="col-md-3">
                    <div class="card sticky-side-menu-top mt-3">
                        <div class="card-body">
                            ...
                            <form method="get" action="{{route('search.search_question')}}">

                                <div class="form-group">
                                    <textarea class="form-control {{$errors->has('content') ? 'is-invalid' : '' }}" id="content" name="content" rows="4" placeholder="{{__('text.Search in questions ...')}}">@isset($content){{$content}}@endisset</textarea>
